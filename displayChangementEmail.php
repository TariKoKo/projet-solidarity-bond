...
<body id="compte">
    ...
    <div class="container card ">
        <div class="row">
            ...
            <div class="col-lg-9 couleurCompte2 pt-lg-3 pl-lg-5 b">
                <div class="row">
                    <form method="post" action="scriptChangementEmail.php" autocomplete="on">
                        
                        <div id=register class="form-group text-center">
                            <label for="Inputemail">Ancienne adresse email</label>
                        ...
                        <div id=register class="form-group text-center">
                            <label for="Inputemail">Nouvelle adresse email</label>
                            <input type="email" class="form-control" id="InputEmail" name="NewAdresse_email"
                            placeholder="votreadresse@exemple.com" required="required">
                        </div>
