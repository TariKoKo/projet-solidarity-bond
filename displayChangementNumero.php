    ...
    <div class="container card ">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 couleurCompte2 pt-lg-3 pl-lg-5">
                <div class="row">
                    <form method="post" action="scriptChangementNumero.php" autocomplete="on">

                        <div id="register" class="form-group text-center">
                            <label for="Phonenumber">Ancien numéro de téléphone</label>
                        ...
                        <div id="register" class="form-group text-center">
                            <label for="Phonenumber">Nouveau numéro de téléphone</label>
                            <input type="number" class="form-control" id="numéro" name="NewNumero_tel" maxlength="10"
                                placeholder="Numéro de téléphone" required="required">
                        </div>
