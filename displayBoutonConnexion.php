            ...
            <div class='modal-footer mx-5 pt-3 mb-1'>
                <p class='font-small grey-text d-flex justify-content-end'>Vous n'avez pas de comtpe? <a
                        href='pageInscription.php' class='blue-text ml-1'>S'inscrire</a></p>
                            ...
                            echo '<div id="nom_entreprise" class="mt-4 bd-highlight"/>'.$_SESSION['pseudo'].'</div><div class="bd-highlight text-center"/><a href="scriptDeconnexion.php" id="bouton-connect" class="btn btn-default btn-rounded">Deconnexion</a></div>';
                     }
                     ?>
</div>