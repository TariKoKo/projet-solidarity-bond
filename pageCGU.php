    ...
    <main>
        <div id="container" class="container p-5 mt-5 text-justify mb-5">
            ...
            <p> Les présentes « conditions générales d'utilisation »
                ...
                disposition des services du site et leur utilisation par « l'Utilisateur ».</p>
            <p> Les conditions générales d'utilisation doivent être acceptées par
                tout Utilisateur souhaitant accéder au site. Elles constituent le
                contrat entre le site Solidarity Bond et l'Utilisateur. L'accès au site par
                l'Utilisateur signifie son acceptation des présentes conditions
                générales d'utilisation.</p>
            <p>Éventuellement :</p>
            <ul>
                <li>
                    <p>En cas de non-acceptation des conditions générales d'utilisation
                        stipulées dans le présent contrat, l'Utilisateur se doit de
                        renoncer à l'accès des services proposés par le site.</p>
                </li>
                <li>
                    <p>Solidarity Bond se réserve le droit de modifier unilatéralement et
                        à tout moment le contenu des présentes conditions générales
                        d'utilisation.</p>
                </li>
            </ul>
            <h4>ARTICLE 2 : Mentions légales</h4>
            <p>L'édition du site Solidarity Bond est assurée par l'organanisation d'étudiants du Cesi.</p>
            <h4>ARTICLE 3 : Définitions</h4>
            <p>La présente clause a pour objet de définir les différents termes
                essentiels du contrat :</p>
            <ul>
                <li>
                    <p>Utilisateur : ce terme désigne toute personne qui utilise le
            ...
            <ul>
                ...
                <li>
                    <p>Présentation de la Solution Technologique</p>
                </li>
                <li>
                    <p>Communiquer avec les admins via l'onglet Discussion</p>
                </li>
            </ul>
            <p>Identifiant
                et mot de passe : c'est l'ensemble des informations nécessaires
                ...
                confidentiel.</p>
            <p>Selon le cas :</p>
            <p>L'Utilisateur non membre n'a pas accès aux services réservés aux
                membres. Pour cela, il doit s'identifier à l'aide de son identifiant
                et de son mot de passe.</p>
            <p>Le site met en œuvre tous les moyens mis à sa disposition pour
                assurer un accès de qualité à ses services. L'obligation étant de
                moyens, le site ne s'engage pas à atteindre ce résultat.</p>
            <p>Tout événement dû à un cas de force majeure ayant pour
                conséquence un dysfonctionnement du réseau ou du serveur n'engage
                pas la responsabilité de Solidarity Bond.</p>
            <p>L'accès aux services du site peut à tout moment faire l'objet d'une
            ...
            <p>L'Utilisateur sollicite l'autorisation préalable du site pour toute
                reproduction, publication, copie des différents contenus.</p>
            <p>L'Utilisateur s'engage à une utilisation des contenus du site dans
                un cadre strictement privé. Une utilisation des contenus à des fins
                commerciales est strictement interdite.</p>
            <p>Tout contenu mis en ligne par l'Utilisateur est de sa seule
            ...
            <p>Le contenu de l'Utilisateur peut être à tout moment et pour
            ...
            <p>Les informations demandées à l'inscription au site sont
            ...
            <p>Le site assure à l'Utilisateur une collecte et un traitement
                d'informations personnelles dans le respect de la vie privée
                conformément à la loi n°78-17 du 6 janvier 1978 relative à
                l'informatique, aux fichiers et aux libertés.</p>
            <p>En vertu des articles 48 et suivants de la loi n° 78-17 relative à l'informatique, aux fichiers et aux
                libertés en date du 6 janvier 1978, réécrite par l'ordonnance n° 2018-1125 du 12 décembre 2018
            ...
            <ul>
                ...
                <li>
                    <p>par mail à romain.malarmey@viacesi.fr</p>
                </li>
            </ul>
            <h4>ARTICLE 7 : Responsabilité et force majeure</h4>
            <p>Les sources des informations diffusées sur le site sont réputées
            ...
            <p>L'Utilisateur s'assure de garder son mot de passe secret. Toute
                divulgation du mot de passe, quelle que soit sa forme, est interdite.</p>
            <p>L'Utilisateur assume les risques liés à l'utilisation de son
                identifiant et mot de passe. Le site décline toute responsabilité.</p>
            <p>Tout usage du service par l'Utilisateur ayant directement ou
                indirectement pour conséquence des dommages doit faire l'objet d'une
                indemnisation au profit du site.</p>
            <p>Une garantie optimale de la sécurité et de la confidentialité des
                ...
                données.</p>
            <p>La responsabilité du site ne peut être engagée en cas de force
                majeure ou du fait imprévisible et insurmontable d'un tiers.</p>
            <h4>ARTICLE 8 : Liens hypertextes</h4>
            <p>Quelques liens hypertextes sortants sont présents sur le site,
                cependant les pages web où mènent ces liens n'engagent en rien la
                responsabilité de Solidarity Bond qui n'a pas le contrôle de ces liens.</p>
            <p>L'Utilisateur s'interdit donc à engager la responsabilité du site
                concernant le contenu et les ressources relatives à ces liens
                hypertextes sortants.</p>
            <h4>ARTICLE 9 : Evolution du contrat</h4>
            <p>Le site se réserve à tout moment le droit de modifier les clauses
                stipulées dans le présent contrat.</p>
            <h4>ARTICLE 10 : Durée</h4>
            <p>La durée du présent contrat est indéterminée. Le contrat produit
                ses effets à l'égard de l'Utilisateur à compter de l'utilisation
                du service.</p>
            <h4>ARTICLE 11 : Publication par l'Utilisateur</h4>
            <p>Le site permet aux membres de publier des messages.</p>
            <p>Dans ces publications, le membre s'engage à respecter les règles de la Netiquette et les règles de droit
                en vigueur.</p>
            <p>Le site exerce une modération a priori sur les publications et se réserve le droit de
                refuser leur mise en ligne, sans avoir à s'en justifier auprès du
                membre.</p>
            <p>Le membre reste titulaire de l'intégralité de ses droits de
            ...
            <p>L'organisation éditrice s'engage à faire figurer le nom du membre à
